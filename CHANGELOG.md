...
- **Wireless debugging pairing**: `shg run` / `shg dev --wifi` can now recover after phone restarts with pairing-code recovery and dynamic mDNS connect-port discovery
